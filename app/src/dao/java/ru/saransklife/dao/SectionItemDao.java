...
public class SectionItemDao extends AbstractDao<SectionItem, Long> {
	...
	/**
	 * Properties of entity SectionItem.<br/>
	...
	private Query<SectionItem> sectionItem_ChildrenQuery;

	public SectionItemDao(DaoConfig config) {
		super(config);
	}

	public SectionItemDao(DaoConfig config, DaoSession daoSession) {
	...
	public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
		...
		db.execSQL("CREATE TABLE " + constraint + "'SECTION_ITEM' (" + //
	...
	public static void dropTable(SQLiteDatabase db, boolean ifExists) {
		String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'SECTION_ITEM'";
		db.execSQL(sql);
	}
	 ...
	 */
	@Override
	protected void bindValues(SQLiteStatement stmt, SectionItem entity) {
		stmt.clearBindings();
	...
	@Override
	protected void attachEntity(SectionItem entity) {
	 ...
	 */
	@Override
	public SectionItem readEntity(Cursor cursor, int offset) {
	 ...
	 */
	@Override
	public void readEntity(Cursor cursor, SectionItem entity, int offset) {
	 ...
	 */
	@Override
	protected Long updateKeyAfterInsert(SectionItem entity, long rowId) {
		entity.setId(rowId);
		return rowId;
	}
	 ...
	 */
	@Override
	public Long getKey(SectionItem entity) {
		if (entity != null) {
			return entity.getId();
		} else {
			return null;
	...
	/**
	 * Internal query to resolve the "children" to-many relationship of SectionItem.
	 */
	public List<SectionItem> _querySectionItem_Children(Long parentId) {
		synchronized (this) {
			if (sectionItem_ChildrenQuery == null) {
				QueryBuilder<SectionItem> queryBuilder = queryBuilder();
				queryBuilder.where(Properties.ParentId.eq(null));
				sectionItem_ChildrenQuery = queryBuilder.build();
			}
		}
		Query<SectionItem> query = sectionItem_ChildrenQuery.forCurrentThread();
